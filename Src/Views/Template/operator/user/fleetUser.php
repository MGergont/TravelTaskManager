			...
			<form class="modal-form" action="/user/vehicle/addCosts" method="post">
				...
				<div class="modal-form__row">
					<div class="modal-form__full">
						<div class="field">
							<label for="add_expense_date" class="field__label"><?php $this->LangContents('modal1')?></label>
							<input type="date" id="add_expense_date" name="add_expense_date" class="field__input" placeholder="<?php $this->LangContents('modal1')?>" required>
						</div>
					</div>
				</div>
				<div class="modal-form__row">
					<div class="modal-form__column">
						<div class="field">
							<label for="deit_category" class="field__label"><?php $this->LangContents('modal2')?></label>
		...
		<div class="modal__content">
			...
			<form class="modal-form" action="/user/vehicle/edit" method="post">
				...
				<div class="modal-form__row">
					<div class="modal-form__full">
						<div class="field">
							<label for="edit_expense_date" class="field__label"><?php $this->LangContents('modal1')?></label>
							<input type="date" id="edit_expense_date" name="edit_expense_date" class="field__input" placeholder="<?php $this->LangContents('modal1')?>" required>
						</div>
					</div>
				</div>
				<div class="modal-form__row">
