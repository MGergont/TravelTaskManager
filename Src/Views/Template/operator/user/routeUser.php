					...
					<?php switch ($_SESSION['statusDel']) {
						case 'start': ?>
							<form class="modal-form" method="post" action="/user/route/castom-start">
								...
								<div class="modal-form__row">
									<div class="modal-form__full">
										<div class="field">
											...
											<input type="number" id="Distance" name="Distance" class="field__input" placeholder="<?php $this->LangContents('AddRouteTitle1')?>" required>
										</div>
									</div>
								</div>
								<div class="modal-form__row">
								...
								<button type="submit" name="submit" class="button button--positive"><?php $this->LangContents('btmStart')?></button>
							</form>
						<?php break;
						case 'next': ?>
							<form class="modal-form" method="post" action="/user/route/castom-next">
								...
								<a href="/user/route/castom-end" class="button button--negative"><?php $this->LangContents('btmStop')?></a>
							</form>
						<?php break;
						case 'runtime': ?>
							<p><?php $this->LangContents('AddRouteTitle5')?></p>
							<a href="/user/route/castom-stop"><button name="submit" class="button button--negative"><?php $this->LangContents('btmStop')?></button></a>
						<?php break;
						default: ?>
